    ...
    <div className='relative'>
      {
        <div className='flex justify-end mb-4'>
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className='px-4 mr-10 py-1 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-md hover:from-orange-600 hover:to-orange-700 transition-colors'
            onClick={onViewMore}
          >
            See more
          </motion.button>
