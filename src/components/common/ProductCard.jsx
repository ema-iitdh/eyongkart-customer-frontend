  ...
  return (
    <Link to={`/product/${_id}`}>
      <motion.div
        ...
        className="relative bg-gradient-to-br from-pink-50 via-white to-blue-50 rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300  md:mx-[1rem] sm:h-[420px] h-[380px] flex flex-col group"
      >
        {/* Wishlist Button */}
        <motion.button
          whileTap={{ scale: 0.9 }}
