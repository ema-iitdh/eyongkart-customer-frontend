...
export default function Wishlist() {
  ...
  const { mutate: toggleWishlist, isLoading: isDeleting } = useToggleWishlist();
  ...
  const handleRemoveItem = (productId) => {
    setDeletingId(productId.productId);
  ...
  return (
    <div className='min-h-screen flex flex-col bg-white dark:bg-gray-900 dark:text-white duration-200'>
      <div className='flex-grow w-full px-4 sm:px-6 lg:px-8 py-8'>
        <div className='max-w-7xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6'>
